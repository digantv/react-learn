			  ...
			  <Modal className="modal fade" show={state.sendMessage} onHide={()=>dispatch({type:'sendMessage'})} centered>
				<div className="modal-content">
					<div className="modal-header">
						...
						<Button variant="" type="button" className="close lineheight1"  onClick={() => dispatch({type:'sendMessage'})}>
							<span>×</span>
						</Button>
					</div>
			  ...
			  <Modal show={state.link}  className="modal fade post-input" id="linkModal" onHide={() => dispatch({type:'linkModal'})} centered>
				<div className="modal-content">
					<div className="modal-header">
						...
						<button type="button" className="btn close lineheight1"  onClick={() => dispatch({type:'linkModal'})}>
							<span>×</span>
						</button>
					</div>
					<div className="modal-body">
						<Link className="btn-social me-1 facebook my-1 my-sm-0" to="/app-profile"><i className="fab fa-facebook-f" /></Link>
						<Link className="btn-social me-1 google-plus my-1 my-sm-0" to="/app-profile"> <i className="fab fa-google-plus-g" /></Link>
						<Link className="btn-social me-1 linkedin my-1 my-sm-0" to="/app-profile"><i className="fab fa-linkedin-in" /></Link>
						<Link className="btn-social me-1 instagram my-1 my-sm-0" to="/app-profile"> <i className="fab fa-instagram" /></Link>
			  ...
			  <Modal show={state.camera}  className="modal fade" id="cameraModal" onHide={() => dispatch({type:'cameraModal'})} centered>
				<div className="modal-content">
					<div className="modal-header">
						...
						<button type="button" className="close btn lineheight1" data-dismiss="modal" onClick={() => dispatch({type:'cameraModal'})}>
							<span>×</span>
						</button>
					</div>
					<div className="modal-body">
			  ...
			  <Modal   show={state.reply}  className="modal fade" id="replyModal" onHide={()=>dispatch({type:'replyModal'})} centered>
				<div className="modal-content">
					<div className="modal-header">
						...
						<button type="button" className="close btn lineheight1"  onClick={() => dispatch({type:'replyModal'})}>
							<span>×</span>
						</button>
					</div>
					<div className="modal-body">
