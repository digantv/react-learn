...
//Images
import avater from "../../../assets/images/avatar/1.jpg";
   ...
   return (
      <>
         ...
         <div className="d-md-flex d-block mb-3 align-items-center">
               ...
               <ul className="timeline">
                  <li>
                     ...
                     >
                        ...
                        <p className="fs-14 mb-0 ">20/08/2024, 12:45 AM</p>
                     </Link>
                  </li>
            ...
            <Dropdown className="dropdown d-inline-block ms-auto me-2">
               <Dropdown.Toggle
                  variant=""
                  type="button"
                           ...
                           <div className="d-sm-flex d-block justify-content-between my-3 my-sm-0">
                              <div>
                                 ...
                                 <p className="mb-2 mb-sm-2">
                                    Check In date 25 August 2024, 12:45 AM
                                 </p>
                              </div>
                              <span>#P-00016</span>
                           </div>
                  ...
                  <div className="card-body text-center">
                     ...
                     <div className="mt-4">
                        <p className="mb-2 d-flex text-dark font-w500  fs-14">
                           Immunities (24%)
                           <span className="pull-right ms-auto">25</span>
                        </p>
                        ...
                        <p className="mb-2 d-flex text-dark font-w500  fs-14">
                           Heart Beat (41%)
                           <span className="pull-right ms-auto">12</span>
                        </p>
                        <div className="progress mb-3" style={{ height: 8 }}>
                           <div
                        ...
                        <p className="mb-2 d-flex  text-dark font-w500 fs-14">
                           Weigth (15%)
                           <span className="pull-right ms-auto">15</span>
                        </p>
